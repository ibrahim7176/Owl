...
@section('title','OWL - Register Page')
                    ...
                    <div class="login-form">
                        ...
                        <form class="form" method="post" action="{{route('register.submit')}}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <label>Your Instagram account<span>*</span></label>
                                        <input type="text" name="instagram_account" placeholder="@" required="required" value="{{old('intagram_acount')}}">
                                        @error('name')
                                            <span class="text-danger">{{$message}}</span>
                                        @enderror
                                    </div>
