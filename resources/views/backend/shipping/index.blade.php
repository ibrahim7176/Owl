            ...
            @foreach($shippings as $shipping)   
                <tr>
                    ...
                    <td>
                        ...
                        <a class="ctn btn-primary btn-sm float-left mr-1" href="{{route('export-shipping-data')}}" style="height:30px; width:30px;border-radius:50%"  data-placement="bottom" ><i class="fa-regular fa-file-excel"></i></a>
                    </td>
                    {{-- Delete Modal --}}
